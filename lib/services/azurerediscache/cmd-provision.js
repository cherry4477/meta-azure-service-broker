...
var customLib = require('../../common/random-db-name');
...
var cacheProvision = function(log, params) {
    ...
    var resourceGroupName = reqParams.resourceGroup || 'metadata';
    var cacheName = reqParams.cacheName || customLib.GenRandomDbName(8);
    var location = reqParams.parameters.location || 'southcentralus';
